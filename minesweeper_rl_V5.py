    ...
    for game in range(N_EPISODES):
        ...
        while campo.jogo_ativo:
            ...
            if prev_revelada:
                ...
                risco_penalty = 0.3 * risco_local
                vizinhanca_penalty = 0.5 * celula.bombas_vizinhas
        ...
        if score > record:
            record = score
            model_name = f"model_{N_EPISODES}_partidas_{linhas}_x_{colunas}_{n_bombas}M_V5.pth"
            print(model_name)
